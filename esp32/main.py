...
while True:
    ...
    if prev_snap is None:
        ...
        oled2.text("G:{} Ext:{:.1f}C".format(pg, pe), 0, 20)
        oled2.text("Heat:{:.1f} Cond:{:.3f}".format(phl, pcd), 0, 30)
    ...
    oled.text("G:{} Ext:{:.1f}C".format(gas, ext_temp), 0, 20)
    oled.text("Heat:{:.1f} Cond:{:.3f}".format(heat_load, conduction), 0, 30)
